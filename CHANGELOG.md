...
- Recognition and isolated candidate profiles for the 2026 Mac Studio
  identifiers (`Mac17,14` M5 Max and `Mac17,15` M5 Ultra). They use the same
  explicit LED fade confirmation as other pending hardware and remain disabled
  globally until physical validation.
